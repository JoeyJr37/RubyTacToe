module Game
    ...
    def self.run_game
        ...
        while new_game.win_condition(player_one, player_two) != player_one && new_game.win_condition(player_one, player_two) != player_two && new_game.win_condition(player_one, player_two) != "tie"
            current_player = determine_current_player(player_one, player_two)
            puts "#{current_player.name.capitalize} please select a number: "
            new_game.update_game_board(current_player)
